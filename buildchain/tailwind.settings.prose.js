...
const colorMap = {
  colorDefault: settingsColors.blue['800'],
  colorLead: settingsColors.blue['900'],
  colorLink: settingsColors.blue['800'],
  colorLiBullet: settingsColors.blue['200'],
  colorBorder: settingsColors.blue['200'],
